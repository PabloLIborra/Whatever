...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: WhateverGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("WhateverGenNHibernate", "nhibernateUser", "nhibernatePass");
