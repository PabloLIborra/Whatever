...
/*PROTECTED REGION ID(usingWhateverGenNHibernate.CP.Whatever_Comentario_borrarComentarioEvento) ENABLED START*/
...
{
public void BorrarComentarioEvento (int id_evento)
{
        /*PROTECTED REGION ID(WhateverGenNHibernate.CP.Whatever_Comentario_borrarComentarioEvento) ENABLED START*/
        ...
        try
        {
                ...
                {
                    comentarioCAD.UnrelationerComentarioEvento()
                }
